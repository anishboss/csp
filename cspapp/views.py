...
def index(request):
    if request.method =="POST":
        ...
        if request.POST['algo'] == 'ml' :
            ...
            context = {'total_runs':total_runs,'val1':val1,'val2':val2,'val3':val3,'val4':val4,'val5':val5,'algo':'ml'}
            ...
            print("total runs:",total_runs) 
            context = {'total_runs':total_runs,'val1':val1,'val2':val2,'val3':val3,'val4':val4,'val5':val5,'algo':'rf'}
            return render(request,'cspapp/predict.html',context)
                # return redirect('/predict/', data=total_runs)
